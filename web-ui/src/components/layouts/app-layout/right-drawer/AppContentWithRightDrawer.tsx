...
export function AppContentWithRightDrawer({ children }: PropsWithChildren) {
  ...
  // react-responsive cannot know the viewport during SSR. Render the page
  // content unchanged for the shared server/client pass, then attach the
  // responsive drawer once the browser has mounted.
